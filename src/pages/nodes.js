...
render(){
  const tableElements = this.state.analyses.map((analysis, x) => {
    ...
    if (!includeResult) {
      ...
      analysis.analysis_state_scan_ordered_ts_utc_str.includes(searchTerm) ? includeResult = true : false
      analysis.analysis_state_lambda_export_files_load_dynamo_complete_ts_utc_str.includes(searchTerm) ? includeResult = true : false
      analysis.analysis_id.includes(searchTerm) ? includeResult = true : false
    }
      ...
      <CardTitle title="Nodes"/>
        ...
        <table className="table table-bordered" id="mytable">
          ...
          <tr className="success">
            ...
            <TableHeaderColumn onClick={this.handleSort.bind(null, 'analysis_state_scan_ordered_ts_utc_str')}>Scan ordered <i className="fa fa-sort"></i></TableHeaderColumn>
            <TableHeaderColumn onClick={this.handleSort.bind(null, 'analysis_state_lambda_export_files_load_dynamo_complete_ts_utc_str')}>Date Arrived in Dynamo <i className="fa fa-sort"></i></TableHeaderColumn>
