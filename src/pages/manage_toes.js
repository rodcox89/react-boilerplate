  ...
  const tableElements = this.state.analyses.analysis.map((analysis, x) => {
    ...
    return(
      <TableRow key={x}>
          ...
          <TableRowColumn><Link to="/add_edit_toe"><RaisedButton  label="Edit" secondary={true}></RaisedButton></Link> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; <RaisedButton  label="Scan" secondary={true}></RaisedButton></TableRowColumn>
      </TableRow>
    )
  }
  }, this);
    ...
    <Card>
      ...
      <table className="table table-bordered" style={{width:'100%'}}>
        ...
        <TableHeaderColumn colSpan="2" style={{textAlign: 'right' }}><Link to="/add_edit_toe"><RaisedButton  label="Add Toe" secondary={true}></RaisedButton></Link></TableHeaderColumn>
          ...
          <tr className="success">
          <TableHeaderColumn onClick={this.handleSort.bind(null, 'analyst_edit_analyzed_entity_name')}>Name <i className="fa fa-sort"></i></TableHeaderColumn>
          <TableHeaderColumn onClick={this.handleNumberSort.bind(null, 'security_domain_software_patching_completed')}>Last Scan Date <i className="fa fa-sort"></i></TableHeaderColumn>
