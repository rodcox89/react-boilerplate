...
import TableData from './../components/table/web_encryption/table-data'
import CircularProgress from 'material-ui/lib/circular-progress';



var no_results
let WebEncryption = React.createClass({
  ...
  componentDidMount: function() {
    ...
    onSubmit(e) {
      $.ajax({
      type: 'PUT',
      url: Constants.api_base_url + Constants.api_version + '/analyses/web_encryption/' + localStorage.analysis_id + '/' + localStorage.unique_key,
      crossDomain: true,
      dataType: 'json',
      contentType: 'application/json',
      success: (data) => {
            ...
            <div className="table-responsive">
              <table className="table table-bordered" id="mytable" >
                <thead>
                  ...
                  <TableHeaderColumn style={{"width": "6%"}} onClick={this.handleSort.bind(null,'analyst_status')}>Status <i className="fa fa-sort"></i></TableHeaderColumn>
                  <TableHeaderColumn style={{"width": "6%"}} onClick={this.handleNumberSort.bind(null,'analyst_confidence')}>Confidence <i className="fa fa-sort"></i></TableHeaderColumn>
                  <TableHeaderColumn style={{"width": "auto"}} onClick={this.handleSort.bind(null,'analyst_comments')}>Comments <i className="fa fa-sort" ></i></TableHeaderColumn>
